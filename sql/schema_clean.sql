-- ============================================================================
-- KIVU AGRO BIO - CLEAN SCHEMA
-- ============================================================================
-- Purpose:
--   Human-friendly schema, reorganized by business domain, while staying faithful
--   to the real PostgreSQL database structure extracted from backup on 2026-04-22.
--
-- Fidelity rules:
--   - Same live tables
--   - Same live columns
--   - Same live named constraints
--   - Same live indexes
--   - Same live foreign keys
--   - No role-dependent OWNER / DEFAULT PRIVILEGES statements
--
-- Notes for the AI layer:
--   The current live schema already gives an AI super-agent meaningful coverage of
--   operations, stock, billing, payments, expenses, accounting, and company memory.
--   The optional roadmap at the bottom lists recommended next schema extensions for
--   forecasting, projection, executive copiloting, and cross-functional automation.
-- ============================================================================
...
-- ============================================================================
-- SALES, BILLING, CASH, AND EXPENSES
-- ============================================================================
...
-- ============================================================================
-- DEFAULTS FOR IDENTIFIER COLUMNS
-- ============================================================================
...
-- ============================================================================
-- PRIMARY KEYS, UNIQUE CONSTRAINTS, AND TABLE-LEVEL BUSINESS CONSTRAINTS
-- ============================================================================
...
-- ============================================================================
-- FOREIGN KEYS AND CROSS-DOMAIN RELATIONSHIPS
-- ============================================================================
...
-- ============================================================================
-- AI SUPER-AGENT READINESS ROADMAP (COMMENT ONLY, NOT PART OF LIVE SCHEMA)
-- ============================================================================
-- The live schema already covers:
--   - CEO / direction: business_rules, company_knowledge, sales, stock, finance data
--   - Commercial: customers, invoices, invoice_items, payments
--   - Operations: products, warehouse_stock, stock movements, transfers, transformations
--   - Production: product_recipes, production_batches, production_batch_items
--   - Finance / comptabilite: accounts, fiscal_periods, journal_entries, journal_entry_lines, expenses
--
-- Recommended future extensions for a true predictive super-agent:
--   1. ai_agent_runs
--      Store each AI analysis, recommendation, decision context, user confirmation, and execution result.
--   2. ai_forecasts
--      Persist demand forecasts, cash forecasts, sales projections, stockout risk, and scenario outputs.
--   3. ai_alerts
--      Centralize anomalies: low stock risk, margin erosion, overdue invoices, unusual expenses, slow products.
--   4. ai_action_queue
--      Queue suggested actions by domain: CEO, finance, comptabilite, commercial, marketing, operations.
--   5. document_chunks + embeddings
--      Improve semantic retrieval across procedures, policies, customer history, supplier history, and reports.
--   6. market_signals
--      Capture external price changes, seasonality, competitor notes, and macro context for projections.
--   7. customer_scores
--      Predict churn, payment risk, customer lifetime value, and upsell potential.
--   8. product_demand_snapshots
--      Store daily or weekly product-level KPIs to support demand planning and replenishment forecasting.
--   9. budget_scenarios
--      Compare baseline, prudent, and aggressive financial scenarios for decision support.
--  10. campaign_performance
--      Give the AI marketing memory about channels, spend, conversions, and ROI by campaign.
--
-- Design principle: keep the operational schema authoritative, and let AI tables capture
-- memory, predictions, recommendations, simulations, and execution traces on top of it.
